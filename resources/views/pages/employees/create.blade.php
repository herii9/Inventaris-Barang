                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control" placeholder="Masukkan nama pegawai" value="{{ old('name') }}">
                        </div>
                        <div class="form-group">
                            <label for="NIP" class="form-label"> NIP Pegawai* </label>
                            <input type="text" name="NIP" id="NIP" class="form-control" placeholder="Masukkan NIP Pegawai" value="{{ old('NIP') }}">
                        </div>
